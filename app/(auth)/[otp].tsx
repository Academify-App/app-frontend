...
const OTPVerification = () => {
  const { topHeading, subHeading, title, email, phone, userRole } =
    ...
    <ScrollView className="bg-[#341773]">
      ...
      <SafeAreaView className="relative z-10">
        ...
        <View className="bg-white w-full h-[770px] px-6 py-7 rounded-t-[30px] flex flex-col gap-y-5">
          ...
          {topHeading === "Email Verification" && <EmailVerificationForm emailAddress={email?.toString()} userRole={userRole?.toString()} />}
